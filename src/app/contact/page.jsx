          ...
          <div className="grid grid-cols-1 md:grid-cols-2 w-full">
            ...
            <div className="bg-[#FAF3EB] px-10 py-12">
              ...
              <div className="space-y-6">
                {/* Office Address */}
                <div className="flex items-start gap-4 bg-white px-4 py-6 max-w-full overflow-hidden">
                  <div className="p-2 text-[#FF7300] flex-shrink-0">
                    <FaMapMarkerAlt className="text-3xl sm:text-4xl" />
                  </div>
                  <div className="overflow-hidden">
                    <h1 className="text-orange-500 font-bold text-base sm:text-lg">Office Address</h1>
                    <p className="font-semibold text-gray-600 text-sm sm:text-base break-words">
                ...
                <div className="flex items-start gap-4 bg-white px-4 py-6 max-w-full overflow-hidden">
                  ...
                  <div className="overflow-hidden">
                    <h1 className="text-orange-500 font-bold text-base sm:text-lg">Phone</h1>
                    <div>
                      <p className="font-bold text-gray-600 text-sm sm:text-base">+91 99423 81376</p>
                      <p className="font-bold text-gray-600 text-sm sm:text-base">+91 88808 88495</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4 bg-white px-4 py-6 max-w-full overflow-hidden">
                  ...
                  <div className="overflow-hidden">
                    <h1 className="text-orange-500 font-bold text-base sm:text-lg">Email</h1>
                    <p className="font-bold text-gray-600 text-sm sm:text-base break-words">admin@imayampromoters.com</p>
                  </div>
                </div>
